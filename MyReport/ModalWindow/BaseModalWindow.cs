...
namespace MyReport.ModalWindow
{
    ...
    public abstract class BaseModalWindow : ContentControl
    {
        ...
        public static readonly DependencyProperty DialogContentMarginProperty = DependencyProperty.Register(nameof(DialogContentMargin), typeof(GridLength), typeof(BaseModalWindow), new PropertyMetadata(new GridLength(25, GridUnitType.Star)));
        ...
        public static readonly DependencyProperty DialogContentWidthProperty = DependencyProperty.Register(nameof(DialogContentWidth), typeof(GridLength), typeof(BaseModalWindow), new PropertyMetadata(new GridLength(50, GridUnitType.Star)));
        ...
        public static readonly DependencyProperty TitleProperty = DependencyProperty.Register(nameof(Title), typeof(string), typeof(BaseModalWindow), new PropertyMetadata(default(string)));
        ...
        public static readonly DependencyProperty DialogTopProperty = DependencyProperty.Register(nameof(DialogTop), typeof(object), typeof(BaseModalWindow), new PropertyMetadata(null, UpdateLogicalChild));
        ...
        public static readonly DependencyProperty DialogBottomProperty = DependencyProperty.Register(nameof(DialogBottom), typeof(object), typeof(BaseModalWindow), new PropertyMetadata(null, UpdateLogicalChild));
        ...
        public static readonly DependencyProperty DialogTitleFontSizeProperty = DependencyProperty.Register(nameof(DialogTitleFontSize), typeof(double), typeof(BaseModalWindow), new PropertyMetadata(26D));
        ...
        public static readonly DependencyProperty DialogMessageFontSizeProperty = DependencyProperty.Register(nameof(DialogMessageFontSize), typeof(double), typeof(BaseModalWindow), new PropertyMetadata(15D));
        ...
        public static readonly DependencyProperty DialogButtonFontSizeProperty = DependencyProperty.Register(nameof(DialogButtonFontSize), typeof(double), typeof(BaseModalWindow), new PropertyMetadata(SystemFonts.MessageFontSize));
        ...
        public ModalWindowSettings DialogSettings { get; private set; }

        internal SizeChangedEventHandler SizeChangedHandler { get; set; }

        static BaseModalWindow()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(BaseModalWindow), new FrameworkPropertyMetadata(typeof(BaseModalWindow)));
        }
        ...
        protected BaseModalWindow(Window owningWindow, ModalWindowSettings settings)
        {
        ...
        /// <returns></returns>
        protected virtual ModalWindowSettings ConfigureSettings(ModalWindowSettings settings)
        {
            return settings;
        }

        private void Initialize(Window owningWindow, ModalWindowSettings settings)
        {
            this.OwningWindow = owningWindow;
            this.DialogSettings = this.ConfigureSettings(settings ?? (new ModalWindowSettings()));
            ...
            this.Loaded += this.BaseModalWindowLoaded;
            this.Unloaded += this.BaseModalWindowUnloaded;
        }
        ...
        private void BaseModalWindowLoaded(object sender, RoutedEventArgs e)
        {
            this.OnLoaded();
        }

        private void BaseModalWindowUnloaded(object sender, RoutedEventArgs e)
        {
